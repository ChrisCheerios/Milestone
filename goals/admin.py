...
class Goal_Progress_Admin(admin.ModelAdmin):
    ...
    # Modifies what information is displayed, filter options
    list_display = ['__str__', 'quantity', 'username', 'goal']
    list_filter = ['goal']


# The 'parent' admin class for the different types of goals.
# Required for polymorphic-models
...
class GoalParentAdmin(PolymorphicParentModelAdmin):
    ...
    # Commenting out above line as Milestone Goals are scrapped from final version
